...
export const JA_PHRASE_FIXES = [
  ...
  { pattern: /崩壊させる/g, replacement: '折りたたむ', whenEnIncludes: 'Collapse Argus' },
  ...
  { pattern: /再起動します/g, replacement: '再起動', whenEnIncludes: 'Restart Argus' },
  ...
  // Argus's host covers SSH hosts and this computer; skipped where the English also says server.
  {
