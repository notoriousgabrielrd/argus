...
export const ZH_VALUE_OVERRIDES = {
  ...
  'Argus IDE': 'Argus IDE',
  'Argus first': 'Argus 优先',
  'Argus Mobile': 'Argus Mobile',
  'Argus logo': 'Argus 标志',
  'Enjoying Argus?': '喜欢 Argus 吗？',
  'Get to know Argus': '了解 Argus',
  'Expand Argus': '展开 Argus',
  'Support Argus': '支持 Argus',
  'Restarting Argus…': '正在重启 Argus…',
  'Argus Attribution': 'Argus 归因',
  'Show Argus Mobile Button': '显示 Argus Mobile 按钮',
  ...
  "Give agents direct access to Argus's browser so they can test pages, capture screenshots, and act on what they see.":
    '让代理直接访问 Argus 的浏览器，以便测试页面、捕获屏幕截图并根据所见内容执行操作。',
  ...
  'from Argus. It is still on your disk.': '来自 Argus。它仍保留在您的磁盘上。',
