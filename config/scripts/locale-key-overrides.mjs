...
const BASE_LOCALE_KEY_OVERRIDES = {
  ...
  'menu.showMobileButton': {
    ko: 'Argus 모바일 버튼 표시',
    zh: '显示 Argus Mobile 按钮',
    ja: 'Argus Mobile ボタンを表示'
  },
  ...
  'menu.exploreOrca': { ko: 'Argus 둘러보기', zh: '探索 Argus', ja: 'Argus を探索' },
  ...
  // Onboarding pill beside Argus Mobile: "New" marks a new feature, not a create action.
