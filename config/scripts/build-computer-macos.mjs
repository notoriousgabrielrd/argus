...
const appPath = path.join(packagePath, '.build', 'release', 'Argus Computer Use.app')
...
const bundleId = process.env.ORCA_COMPUTER_MACOS_BUNDLE_ID ?? 'dev.argus.desktop.computer-use'
const displayName = 'Argus Computer Use'
...
<dict>
  ...
  <string>Argus Computer Use needs Accessibility permission to read and interact with app interfaces when you ask Argus to use apps.</string>
  <key>NSScreenCaptureUsageDescription</key>
  <string>Argus Computer Use needs Screen Recording permission to capture app windows when you ask Argus to inspect your screen.</string>
</dict>
</plist>
`
}
