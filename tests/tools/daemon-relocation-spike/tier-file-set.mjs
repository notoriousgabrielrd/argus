...
// irreducible core (Argus.exe needs icu + snapshots even as node; the daemon
...
export function resolveTierFileSet(inv, tier) {
  ...
  // Core: exe + runtime data blobs live next to Argus.exe in win-unpacked.
  addFile(inv.hostExe, 'Argus.exe')
