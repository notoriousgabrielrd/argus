...
//
// GitHub #7742: when Argus's main/renderer process died on Windows, the terminal
 ...
 * or image-named process, so a live user Argus on the same box is never touched.
 */
