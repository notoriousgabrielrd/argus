...
await write('If Argus leaves wide gray rectangles here, they are stale remote-PTY render artifacts.\\r\\n')
...
await write('Tip: deterministic fixture for Argus SSH Codex display artifacts.\\r\\n\\r\\n')
