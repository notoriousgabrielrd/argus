...
export const ORCHESTRATION_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage: 'argus orchestration run-create --objective <text> [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage:
      'argus orchestration run-use --id <run_id> [--from <handle>] [--takeover-legacy] [--json]',
  ...
  },
  {
    ...
    usage:
      'argus orchestration send --subject <text> [--to <run:id|dispatch:id|legacy_handle>] [--run <run_id>] [--from <handle>] [--body <text>] [--type <type>] [--priority <level>] [--thread-id <id>] [--payload <json>] [--task-id <id>] [--dispatch-id <id>] [--outcome <succeeded|failed>] [--files-modified <csv>] [--report-path <path>] [--phase <text>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'to',
      'run',
    ...
    notes: [
      ...
      'Use --to dispatch:<id> for attempt-specific coordinator guidance; Argus durably relays it to a connected worker server.',
  ...
  },
  {
    ...
    usage:
      'argus orchestration check [--terminal <handle>] [--run <run_id>] [--ack <delivery_id>] [--unread | --peek | --all] [--types <type,...>] [--format] [--wait] [--timeout-ms <n>] [--json]\n' +
  ...
  },
  {
    ...
    usage:
      'argus orchestration reply --id <msg_id> --body <text> [--run <run_id>] [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage: 'argus orchestration inbox [--limit <n>] [--terminal <handle>] [--full] [--json]',
  ...
  },
  {
    ...
    usage:
      'argus orchestration task-create --spec <text> [--task-title <text>] [--display-name <text>] [--deps <json_array>] [--parent <task_id>] [--run <run_id>] [--from <handle>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'spec',
      'task-title',
  ...
  },
  {
    ...
    usage:
      'argus orchestration task-list [--status <status>] [--ready] [--brief] [--run <run_id>] [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage:
      'argus orchestration task-update --id <task_id> --status <status> [--result <json>] [--run <run_id>] [--from <handle>] [--json]',
  ...
  ...ORCHESTRATION_WORKER_COMMAND_SPECS,
  {
    ...
    usage:
      'argus orchestration dispatch --task <task_id> --to <handle> [--from <handle>] [--run <run_id>] [--inject] [--dry-run] [--return-preamble] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'task',
      'to',
  ...
  },
  {
    ...
    usage:
      'argus orchestration dispatch-show --task <task_id> [--preamble] [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage:
      'argus orchestration ask (--question <text> | --resume <message_id>) [--to <run:id>] [--run <run_id>] [--options <csv>] [--timeout-ms <n>] [--from <handle>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'to',
      'run',
  ...
  },
  {
    ...
    usage:
      'argus orchestration coordinator-start --spec <text> [--from <handle>] [--poll-interval-ms <n>] [--max-concurrent <n>] [--worktree <selector>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'spec',
      'from',
  ...
  },
  {
    ...
    summary: 'Retired: load the current orchestration skill',
    usage: 'argus orchestration coordinator-stop [--json]',
  ...
  },
  {
    ...
    usage:
      'argus orchestration gate-create --task <task_id> --question <text> [--options <json_array>] [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage:
      'argus orchestration gate-resolve --id <gate_id> --resolution <text> [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage:
      'argus orchestration gate-list [--task <task_id>] [--status <status>] [--run <run_id>] [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage: 'argus orchestration reset (--all | --tasks | --messages) [--json]',
