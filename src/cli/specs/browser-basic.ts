...
export const BROWSER_BASIC_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    usage:
      'argus wait [--selector <sel>] [--timeout <ms>] [--text <text>] [--url <pattern>] [--load <state>] [--fn <js>] [--state <hidden|visible>] [--worktree <selector>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'selector',
      'timeout',
  ...
  },
  {
    ...
    usage:
      'argus tab switch (--index <n> | --page <id>) [--worktree <selector>] [--focus] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'index', 'page', 'worktree', 'focus']
  },
  {
    path: ['tab', 'create'],
    summary: 'Create a new browser tab in the current worktree',
    usage: 'argus tab create [--url <url>] [--worktree <selector>] [--profile <id>] [--json]',
  ...
  },
  {
    ...
    usage: 'argus tab profile list [--json]',
  ...
  },
  {
    ...
    usage:
      'argus tab profile create --label <name> [--scope <isolated|imported>] [--no-ua-spoof] [--json]',
