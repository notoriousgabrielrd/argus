...
export const SERVE_COMMAND_SPECS: CommandSpec[] = [
  {
    path: ['serve'],
    summary: 'Start an Argus runtime server without opening a desktop window',
    usage:
    ...
    examples: [
      'argus serve',
      'argus serve --json',
      'argus serve --project-root /workspace/repo --pairing-address wss://sandbox.example.com --recipe-json',
      'argus serve --port 6768 --pairing-address 100.64.1.20',
      'argus serve --pairing-address 100.64.1.20 --mobile-pairing'
    ]
  }
]
