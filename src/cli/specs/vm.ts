...
export const VM_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage:
      'argus vm recipe doctor <recipe-id> [--repo-path <path>] [--provision|--connect] [--json]',
    ...
    examples: [
      'argus vm recipe doctor cloud-sandbox',
      'argus vm recipe doctor cloud-sandbox --repo-path /path/to/repo --json',
      'argus vm recipe doctor cloud-sandbox --provision --json'
    ]
  }
]
