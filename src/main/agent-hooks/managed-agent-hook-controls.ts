...
// Argus's script, but the presence gate below then skips install() forever, freezing the
// script at whatever Argus generated last. Existing scripts are Orca-owned, so bring them
