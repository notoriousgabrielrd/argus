...
const LINEAR_HELP = `argus linear

Usage: argus linear <command> [options]
...
Run \`argus linear <command> --help\` for command-specific usage.`

const LINEAR_ISSUE_HELP = `argus linear issue

Usage: argus linear issue [<id>] [--current] [--comments] [--children] [--depth <n>] [--attachments] [--relations] [--activity] [--full] [--workspace <id>] [--json]
...
Options:
  ...
  --pairing-code
  --environment
  --current              Use the current Argus worktree linked Linear issue
...
Examples:
  $ argus linear search "auth bug"
  $ argus linear search ENG --workspace all --json`

const LINEAR_TEAM_LIST_HELP = `argus linear team list

Usage: argus linear team list [--workspace <id>|all] [--json]

List connected Linear teams`

const LINEAR_TEAM_MEMBERS_HELP = `argus linear team members

Usage: argus linear team members --team <key|id> [--workspace <id>] [--json]

List Linear team members`

const LINEAR_TEAM_STATES_HELP = `argus linear team states

Usage: argus linear team states --team <key|id> [--workspace <id>] [--json]

List Linear team workflow states`

const LINEAR_TEAM_LABELS_HELP = `argus linear team labels

Usage: argus linear team labels --team <key|id> [--workspace <id>] [--json]

List Linear team labels`

const LINEAR_PROJECT_LIST_HELP = `argus linear project list

Usage: argus linear project list [--query <text>] [--limit <n>] [--workspace <id>|all] [--json]

List connected Linear projects`

const LINEAR_LIST_HELP = `argus linear list

Usage: argus linear list [--filter assigned|created|all|completed|open] [--team <key|id>] [--limit <n>] [--workspace <id>|all] [--json]
