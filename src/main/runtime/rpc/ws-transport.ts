// WebSocket transport letting mobile clients reach the Argus runtime over LAN (wss:// with TLS, else ws://); auth is per-device tokens, independent of transport encryption.
