...
// a closed set (the native literal plus the labels Argus synthesizes from Cursor hooks),
...
// Argus's hook-synthesized spinner state, but only once a Cursor-owned title already
