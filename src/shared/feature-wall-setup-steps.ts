...
export const FEATURE_WALL_SETUP_STEPS: readonly FeatureWallSetupStep[] = [
  ...
  {
    id: 'browser',
    name: "Use Argus's browser",
    subtitle: "Use Argus's browser",
    description:
      'Browse your web app without leaving Argus. Grab any element and send its exact source and styles to an agent with one click.'
  },
  {
    id: 'notifications',
  ...
  },
  {
    ...
    name: 'Enable Argus CLI',
    subtitle: 'Enable Argus CLI',
    description:
      'Register the Argus shell command and install agent skills for browser, computer, and orchestration workflows.'
  },
  {
    id: 'task-sources',
  ...
  },
  {
    ...
    description:
      'Bring your key repos into Argus so you can start agent work without hunting for folders.'
  }
] as const
