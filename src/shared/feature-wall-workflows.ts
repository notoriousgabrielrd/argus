...
export const FEATURE_WALL_WORKFLOWS: readonly FeatureWallWorkflow[] = [
  {
    ...
    lede: 'Argus splits each task into an isolated workspace so agents can run in parallel.',
  ...
  },
  {
    ...
    title: 'Agents',
    meta: 'Agents · Usage · Argus CLI',
    lede: 'Run several agents at once, track their progress, and let automation drive Argus when it helps.',
  ...
  },
  {
    ...
    lede: 'Bring your terminal setup into Argus, then split panes to keep servers, tests, logs, and agents running side by side.',
