...
export const HOURLY_RELEASE_REPO = 'stablyai/argus-hourly'
export const DAILY_RELEASE_REPO = 'stablyai/argus-daily'
export const ADHOC_RELEASE_REPO = 'stablyai/argus-adhoc'
