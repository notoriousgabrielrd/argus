...
export const SOURCE_CONTROL_ACTION_VARIABLE_INFO = {
  basePrompt: {
    description:
      'Argus’s built-in prompt for this action, including the context Argus knows how to gather safely.',
    example:
  ...
  firstPrompt: {
    description: 'The first user request that created the Argus workspace.',
    example: 'Fix CI and commit the result'
  },
  assistantMessage: {
    description: 'The initial agent response, when Argus has one available.',
