...
describe('skills CLI agent keys', () => {
  ...
  it('covers every agent Argus can detect', () => {
  ...
  it("follows Argus's own evidence for the two non-obvious mappings", () => {
    ...
    // Why: Argus detects trae via `traecli`, which tui-agent-config calls an alias
