...
export type SshTarget = {
  id: string
  label: string
  /** Internal owner for targets that Argus creates as implementation details.
...
export type SshConfigHostSummary = {
  ...
  proxyCommand?: string
  jumpHost?: string
  /** True when an Argus SSH target already uses this config alias. */
  alreadyInOrca: boolean
  /**
   * True when the user deleted this alias from Argus (tombstone). Still listed so they
