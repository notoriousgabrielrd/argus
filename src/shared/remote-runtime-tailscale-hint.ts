...
const REMOTE_RUNTIME_UNREACHABLE_RE =
  /could not connect to the remote argus runtime|remote argus runtime closed the connection|timed out (?:waiting for|while connecting to) the remote argus runtime/i
