...
// Why device-wide wording: the gate has no caller identity, so `argus artifacts share` typed by a
...
export const ARTIFACT_SHARING_DISABLED_NEXT_STEPS: readonly string[] = [
  'Open Settings → Artifacts in the Argus desktop app on this device.',
