...
const REQUEST_TRANSPORT_ERRORS: TransportErrorPair[] = [
  ...
  },
  {
    ...
    message: 'Timed out waiting for the remote Argus runtime to respond.'
  },
  {
  ...
  },
  {
    ...
    message: 'Could not connect to the remote Argus runtime.'
  },
  {
    producer: 'remote-runtime-client.ts:270 / :667 (formatRemoteRuntimeCloseMessage, 1006)',
    code: 'remote_runtime_unavailable',
    message: 'Remote Argus runtime closed the connection.'
  },
  {
    producer: 'remote-runtime-client.ts:270 / :667 (formatRemoteRuntimeCloseMessage, 1011)',
    code: 'remote_runtime_unavailable',
    message: `Remote Argus runtime closed the connection (1011: ${CLOSE_REASON.toString()}).`
  },
  {
    producer: 'remote-runtime-client.ts:289',
    code: 'invalid_runtime_response',
    message: 'Remote Argus runtime returned an unexpected binary frame.'
  },
  {
    producer: 'remote-runtime-client.ts:310 / :693',
    code: 'invalid_runtime_response',
    message: 'Remote Argus runtime returned an undecryptable frame.'
  },
  {
  ...
  },
  {
    ...
    code: 'remote_runtime_unavailable',
    message: 'Remote Argus runtime request was released before it could be sent.'
  },
  {
    producer: 'remote-runtime-client.ts:459 / :829',
    code: 'invalid_runtime_response',
    message: 'Remote Argus runtime returned a mismatched response id.'
  },
  {
  ...
  },
  {
    ...
    code: 'runtime_timeout',
    message: 'Timed out waiting for the remote Argus runtime subscription to start.'
  },
  {
    producer: 'remote-runtime-client.ts:587',
    code: 'remote_runtime_unavailable',
    message: 'Remote Argus runtime send buffer overflow; reconnecting.'
  },
  {
  ...
  },
  {
    ...
    code: 'invalid_runtime_response',
    message: 'Remote Argus runtime returned binary data before authentication.'
  },
  {
    producer: 'remote-runtime-client.ts:852',
    code: 'invalid_runtime_response',
    message: 'Remote Argus runtime returned an undecryptable binary frame.'
  },
  {
  ...
  producedPair(
    ...
    invalidRemoteRuntimeResponseError('Remote Argus runtime returned an invalid E2EE auth frame.')
  ),
  producedPair(
...
const SHARED_CONTROL_TRANSPORT_ERRORS: TransportErrorPair[] = [
  ...
  producedPair(
    ...
    remoteRuntimeUnavailableError(
      'Remote Argus runtime stopped responding; resetting the control connection.'
    )
  ),
  producedPair(
...
const HOST_FORWARDED_TRANSPORT_ERRORS: TransportErrorPair[] = [
  ...
  },
  {
    producer: 'main/runtime/rpc/errors.ts:145 (STRUCTURED_RUNTIME_PASSTHROUGH_CODES)',
    code: 'invalid_runtime_response',
    message: 'Remote Argus runtime returned an invalid response frame.'
  },
  {
    producer: 'main/runtime/rpc/errors.ts:145 (STRUCTURED_RUNTIME_PASSTHROUGH_CODES)',
...
const CODELESS_TRANSPORT_ERRORS: (TransportErrorPair & { recoverable: boolean })[] = [
  {
    ...
    message: 'Remote Argus runtime is not connected.',
    recoverable: true
  },
  {
    producer: 'web-runtime-client.ts:359 / :360 / :591',
    message: 'Remote Argus runtime connection closed.',
    recoverable: true
  },
  {
