...
export const createOrcaProfilesSlice: StateCreator<AppState, [], [], OrcaProfilesSlice> = (
  ...
  fetchOrcaProfiles: async () => {
    ...
    try {
      ...
      console.error('Failed to fetch Argus profiles:', err)
  ...
  fetchOrcaProfileAuthStatus: async () => {
    try {
      ...
      console.error('Failed to fetch Argus profile auth status:', err)
      return null
    }
  },
  ...
  createLocalOrcaProfile: async (name) => {
    try {
      ...
      console.error('Failed to create Argus profile:', err)
      toast.error(
  ...
  switchOrcaProfile: async (profileId) => {
    ...
    try {
      ...
      console.error('Failed to switch Argus profile:', err)
      set({ orcaProfileSwitching: false })
      toast.error(
  ...
  transferOrcaProfileProject: async (args) => {
    try {
      ...
      console.error('Failed to transfer Argus profile project:', err)
      toast.error(
