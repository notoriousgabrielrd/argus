...
describe('createEditorSlice activateMarkdownLink', () => {
  ...
  it('opens in-worktree file links in Argus', async () => {
    const store = createEditorStore()
  ...
  it('opens explicit file URLs inside the worktree in Argus', async () => {
    const store = createEditorStore()
  ...
  it('opens explicit file URLs outside the worktree in Argus after authorizing them', async () => {
    const store = createEditorStore()
