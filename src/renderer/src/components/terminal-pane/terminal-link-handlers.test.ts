...
describe('handleOscLink', () => {
  ...
  it('uses the system browser for shift+cmd/ctrl+click even when Argus browser tabs are enabled', () => {
    setPlatform('Windows')
    storeState.settings = { openLinksInApp: true }
  ...
  it('opens local .html file paths in Argus browser tabs with the platform modifier', async () => {
    setPlatform('Macintosh')
  ...
  it('also opens local .htm paths in Argus browser tabs with the platform modifier', async () => {
    setPlatform('Macintosh')
  ...
  it('opens local file paths in Argus and reveals default column 1 with the platform modifier', async () => {
    setPlatform('Macintosh')
  ...
  it('preserves explicit column for Argus opens from :line:column links', async () => {
    setPlatform('Macintosh')
  ...
  it('falls back to Argus when shift+cmd/ctrl-click system default open fails', async () => {
    setPlatform('Macintosh')
  ...
  it('opens local file URL links in Argus with the platform modifier on desktop', async () => {
    setPlatform('Windows')
  ...
  it('opens #L file URL links in Argus and preserves anchors', async () => {
    setPlatform('Macintosh')
  ...
  it('opens SSH file links through Argus without local authorization', async () => {
    setPlatform('Macintosh')
  ...
  it('ignores stale async completion so latest local click wins for Argus open and reveal', async () => {
    setPlatform('Macintosh')
...
describe('createFilePathLinkProvider range bounds', () => {
  ...
  it('shows the Argus plus default-app hint for local file link hover', async () => {
    setPlatform('Macintosh')
  ...
  it('shows the Argus hint for SSH file link hover', async () => {
    setPlatform('Macintosh')
    vi.mocked(getConnectionId).mockReturnValue('ssh-1')
    const { provider, linkTooltip } = createProviderSetup([makeBufferLine('CLAUDE.md')])
    ...
    expect(linkTooltip.textContent).toBe(
      '/repo/CLAUDE.md (Click for actions or ⌘+click to open in Argus)'
    )
  })
