...
export function useMacNotificationPermissionState(
  ...
  useEffect(() => {
    // Why: while Argus's own notifications setting is off, the OS permission
          ...
          <div className="min-w-0 space-y-1">
            <div className="flex items-center gap-2 text-sm font-semibold text-amber-700 dark:text-amber-300">
              ...
              {translate(
                ...
                'macOS is not delivering Argus notifications'
              )}
            </div>
            <p className="max-w-[58ch] text-[13px] leading-relaxed text-amber-700/80 dark:text-amber-200/80">
              {translate(
                ...
                'Turn on Allow notifications for Argus in System Settings.'
              )}
            </p>
          </div>
          <Button
