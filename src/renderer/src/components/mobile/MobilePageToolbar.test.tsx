...
describe('MobilePageToolbar', () => {
  it('labels the sidebar toggle explicitly when Argus Mobile is visible in the sidebar', () => {
    ...
    expect(html).not.toContain('Remove Argus Mobile')
  })

  it('labels the restore action explicitly when Argus Mobile is hidden from the sidebar', () => {
    const html = renderToStaticMarkup(
      <MobilePageToolbar
