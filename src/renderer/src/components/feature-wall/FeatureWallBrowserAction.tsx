...
// needs the Argus CLI and browser skill, not Computer Use or orchestration.
...
// The grab→agent flow relies on the Argus CLI and browser skill, so offer the same
// install action the Enable Argus CLI step uses, scoped to just browser use.
