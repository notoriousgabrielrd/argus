...
// Mac-style terminal traffic-light dots — the signature of an Argus terminal pane.
...
// Use Argus's browser: a browser pane with a cursor grabbing one highlighted
