...
describe('getDeleteWorktreeToastCopy', () => {
  ...
  // that as an unconfirmed exit — the user is killing a terminal Argus watched running.
  ...
  it('uses stale-row guidance when Git already removed the worktree directory', () => {
    expect(
      ...
      title: 'Failed to delete workspace feature/foo',
      description: 'Git already removed this workspace. Use Force Delete to clear it from Argus.',
      isDestructive: false
    })
  })
