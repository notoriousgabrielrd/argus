...
import { Plug, Files, GitBranch, ListChecks, NotebookPen, PanelRight, Workflow } from 'lucide-react'
  ...
  const activityItems = useMemo<ActivityBarItem[]>(
    () => [
      ...
      },
      {
        id: 'obsidian',
        icon: NotebookPen,
        title: translate('auto.components.right.sidebar.index.obsidianVault', 'Obsidian'),
        shortcut: ''
      },
      {
        id: 'workspaces',
