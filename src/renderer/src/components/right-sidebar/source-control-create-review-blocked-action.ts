...
export function resolveUnavailableCreateReviewLookupNoticeMessage(
  ...
  return `Create ${copy.shortLabel} failed: Argus could not confirm whether this branch already has a ${copy.reviewLabel}. Retry once the ${copy.providerName} lookup succeeds.`
}
