    ...
    <UsageTrackingPaneShell
      ...
      filterSections={[
        <UsageFilterRadioGroup
          ...
          value="orca"
          options={[
            { value: 'orca', label: 'Argus worktrees only' },
      ...
      selectionSummary="Argus worktrees only • Last 7 days"
...
describe('UsageTrackingPaneShell', () => {
  ...
  it('renders the empty state and wires header actions', async () => {
    ...
    expect(screen.getByText('Argus worktrees only • Last 7 days')).toBeInTheDocument()
