...
const CLI_AGENT_COMMANDS = [
  'argus worktree create --name auth-pr-1',
  'argus worktree create --name auth-pr-2',
  'argus orchestration dispatch --task pr1 --to w1',
  'argus orchestration dispatch --task pr2 --to w2'
]
