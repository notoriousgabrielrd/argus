      ...
      void preparation
        .then((result) => {
          ...
          if (!startup) {
            ...
            throw new Error(
              result.substituteCodexHome
                ? 'This session was dragged from an older Argus window, so Argus cannot retarget it to the selected Codex account. Resume it from the Session History panel instead.'
                : 'Argus could not prepare this legacy Codex session. Retry resume.'
            )
          }
