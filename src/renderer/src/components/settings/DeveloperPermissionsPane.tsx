  ...
  },
  {
    ...
    get description() {
      return translate(
        ...
        "macOS names Argus when the agents it runs read other apps' data, because Argus is the responsible process for terminal commands. Grant this to Argus to reduce those prompts. Then quit and reopen Argus."
      )
    },
    get actionLabel() {
      return translate(
  ...
  },
  {
    ...
    get description() {
      return translate(
        ...
        "Allows terminals and development tools to connect to services on your local network. macOS does not report this permission's current status to Argus."
      )
    },
    get actionLabel() {
      return translate(
...
export function DeveloperPermissionsPane({
  ...
  // back to Argus, the chip should reflect the new status without a manual
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-2 text-sm font-medium">
            ...
            {translate(
              ...
              "Terminal tools inherit Argus's macOS privacy envelope."
            )}
          </div>
          <p className="text-xs text-muted-foreground">
            {translate(
              'auto.components.settings.DeveloperPermissionsPane.6326a4c5cc',
              'Use these controls when a CLI, local app, or automation tool needs macOS privacy access. Argus does not ask at startup.'
            )}
          </p>
        </div>
