    ...
    <section className="space-y-3">
      <SettingsSubsectionHeader
        ...
        description={translate(
          ...
          'Choose whether Argus launches agents with fewer permission prompts or with manual checks.'
        )}
        action={
...
export function AgentsPane({
  ...
  // (preflight:refreshAgents). This handles the "installed a new CLI, Argus
