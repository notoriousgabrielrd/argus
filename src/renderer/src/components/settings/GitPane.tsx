...
export function GitPane({
  ...
  const visibleSections = [
    ...
    matchesSettingsSearch(searchQuery, {
      title: translate('auto.components.settings.GitPane.e02ea23a32', 'Argus Attribution'),
      description: translate(
      ...
      >
        <div className="space-y-0.5">
          <Label>
            {translate('auto.components.settings.GitPane.e02ea23a32', 'Argus Attribution')}
          </Label>
          <p className="text-xs text-muted-foreground">
            {translate(
              'auto.components.settings.GitPane.d2eede4c54',
        ...
        <Switch
          aria-label={translate('auto.components.settings.GitPane.e02ea23a32', 'Argus Attribution')}
