...
const AGENT_PROMPT =
  'Use the argus-per-workspace-env skill to set up a per-workspace environment for this repo.'
        ...
        <ul className="space-y-2">
          <WhatItem
            text={translate(
              ...
              'Writes the recipe & scripts for your provider — connected over an Argus server or SSH.'
            )}
          />
          <WhatItem
            text={translate(
