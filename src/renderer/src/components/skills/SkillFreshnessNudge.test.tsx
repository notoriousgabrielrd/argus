...
function placement(
  ...
  return {
    ...
    unresolvedPath: '/home/.agents/skills/argus-cli',
    resolvedPath: '/home/.agents/skills/argus-cli',
    physicalIdentity: 'physical-argus-cli',
...
const DISMISSAL_KEY = ['physical-argus-cli', 'argus-cli', '2'].join('\0')
    ...
    mocks.inventory = {
      ...
      installations: [
        ...
        placement({
          ...
          topology: 'repo-scope',
          sourceKind: 'repo',
          unresolvedPath: '/home/projects/work/.agents/skills/argus-cli',
          resolvedPath: '/home/projects/work/.agents/skills/argus-cli',
          physicalIdentity: 'physical-repo-argus-cli'
        })
      ],
      eligibleUpdateNames: ['argus-cli'],
      scanIssues: [],
    ...
    mocks.inventory = {
      ...
      installations: [
        ...
        placement({
          ...
          topology: 'repo-scope',
          sourceKind: 'repo',
          physicalIdentity: 'physical-repo-argus-cli-after-checkout'
        })
      ],
      eligibleUpdateNames: ['argus-cli'],
      scanIssues: [],
