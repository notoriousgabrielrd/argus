...
This file is a discovery stub, not the usage guide. The full, version-matched Argus
...
worktree management, and the built-in browser. Coordination requires real Argus runtime
