...
Engage Argus's computer-use surface whenever you must inspect or operate a local desktop app
...
windows, webviews, and Argus's own UI. Triggers include "computer use", "argus computer",
